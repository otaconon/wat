...
1. przemienne: $F, \wedge, \text{XOR}, \vee, \text{NOR}, \Leftrightarrow, \text{NAND}, T$
2. łączne: $\wedge, \vee, \Leftrightarrow, \text{XOR}$
3. łączne prawostronnie: $\Rightarrow$
4. rozdzielne względem siebie: $\wedge, \vee$
