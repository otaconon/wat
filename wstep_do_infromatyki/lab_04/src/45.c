...
int main() {
  ...
  int arr2[] = {1, 4, 3, 9, 10, 2};
  int n = sizeof(arr1) / sizeof(int);

  print_array(arr1, n, "Tablica:");
  printf("\n\nDlugosc najdluzszego podciagu rosnacego: %d\n\n", solve(arr1, n));

  print_array(arr2, n, "Tablica:");
  printf("\n\nDlugosc najdluzszego podciagu rosnacego: %d", solve(arr2, n));
}